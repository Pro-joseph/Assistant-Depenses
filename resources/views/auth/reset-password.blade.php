...
@section('title', 'Assistant Dépenses - Nouveau mot de passe')
...
@section('auth-card')
    <div class="bg-surface-container-lowest border border-outline-variant rounded-xl shadow-md p-xl">
        <h2 class="text-xl font-medium text-on-surface mb-lg">Réinitialiser le mot de passe</h2>
            ...
            <div class="space-y-lg">
                <div class="space-y-xs">
                    ...
                    <div class="relative group">
                        ...
                        <input class="w-full pl-xxl pr-md py-md bg-surface-container-low border border-outline-variant rounded-lg text-sm focus:ring-2 focus:ring-primary-container focus:border-primary transition-all outline-none" id="email" name="email" placeholder="nom@exemple.com" required type="email" value="{{ old('email', $request->email) }}" readonly>
                    </div>
                    @error('email')
                ...
                <div class="space-y-xs">
                    <label class="text-xs text-on-surface-variant uppercase tracking-wider font-medium" for="password">Nouveau mot de passe</label>
                    <div class="relative group">
                        ...
                        <input class="w-full pl-xxl pr-md py-md bg-surface-container-low border border-outline-variant rounded-lg text-sm focus:ring-2 focus:ring-primary-container focus:border-primary transition-all outline-none" id="password" name="password" placeholder="••••••••" required type="password" autocomplete="new-password">
                    </div>
                    @error('password')
                        <p class="text-sm text-error mt-xs">{{ $message }}</p>
                    @enderror
                ...
                <div class="space-y-xs">
                    <label class="text-xs text-on-surface-variant uppercase tracking-wider font-medium" for="password_confirmation">Confirmer le mot de passe</label>
                    <div class="relative group">
                        ...
                        <input class="w-full pl-xxl pr-md py-md bg-surface-container-low border border-outline-variant rounded-lg text-sm focus:ring-2 focus:ring-primary-container focus:border-primary transition-all outline-none" id="password_confirmation" name="password_confirmation" placeholder="••••••••" required type="password" autocomplete="new-password">
                    </div>
                </div>
